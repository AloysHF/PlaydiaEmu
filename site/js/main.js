...
(function () {
  ...
  var translations = {
    zh: {
      ...
      'stat-display': '输出画面',
      'stat-display-sub': '248×216 · 4:3 · XA ADPCM 44.1 kHz',
      'feat-title': '核心特性',
      ...
      'feat-video-desc': '恢复的行标记 / VLC 解码产出可识别的 248×216 XRGB8888 画面，并按 4:3 显示。',
      ...
      'feat-state-desc': '光盘身份 + CRC 信封，版本 6 保存完整的 HLE 播放状态。',
    ...
    en: {
      ...
      'feat-video-desc': 'Recovered row-marker / VLC decoding produces recognizable 248×216 XRGB8888 pictures presented at 4:3.',
      ...
      'feat-state-desc': 'Disc identity + CRC envelope; version 6 stores the complete HLE playback state.',
