...
(function () {
  ...
  var translations = {
    zh: {
      ...
      'feat-state-desc': '内容身份 + CRC 信封，版本 2 保存 RGB888 像素；独立版与 libretro 共用同一套状态。',
    ...
    en: {
      ...
      'feat-state-desc': 'Content identity + CRC envelope; version 2 stores RGB888 pixels and is shared by standalone and libretro.',
